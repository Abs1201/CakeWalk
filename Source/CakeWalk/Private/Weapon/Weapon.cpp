...
#include "Player/CakePlayerController.h"
...
//	}
//	else {
//		OwnerCharacter = OwnerCharacter == nullptr ? Cast<ACakeCharacter>(Owner) : OwnerCharacter;
...
{
	//OwnerCharacter = OwnerCharacter == nullptr ? Cast<ACakeCharacter>(GetOwner()) : OwnerCharacter;
	//if (OwnerCharacter) {
	//	OwnerController = OwnerController == nullptr ? Cast<ACakePlayerController>(OwnerCharacter->Controller) : OwnerController;
	//	if (OwnerController) {
...
{
	ACakeCharacter* CakeCharacter = Cast<ACakeCharacter>(OtherActor);
	if (CakeCharacter) {
		CakeCharacter->SetOverlappingWeapon(this);
	}
}
...
void AWeapon::OnSphereEndOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	ACakeCharacter* CakeCharacter = Cast<ACakeCharacter>(OtherActor);
	if (CakeCharacter) {
		CakeCharacter->SetOverlappingWeapon(nullptr);
	}
}
